...
# Hidden-overlap correlation engine — moved to .correlation submodule.
...
# _build_structural_priority moved to .structural; re-exported above.
...
# _detect_regular_plan_holdings, _build_base_name_index, _scheme_base_name,
# _VARIANT_SUFFIXES_RE moved to .structural; re-exported above.
...
# _enrich_correlations moved to .correlation; re-exported above.
